...
<?php
$ids=$_GET['id'];
$sql="SELECT * FROM `product_master` WHERE id={$ids}";
$result=mysqli_query($db,$sql);
$arr=mysqli_fetch_array($result);
if(isset($_POST['update']))
{
if(!empty($_POST['name'])&&!empty($_POST['price'])&&!empty($_POST['dec'])&&!empty($_POST['qty'])&&!empty($_POST['size'])&&!empty($_FILES['file1']))
{
    $name=$_POST['name'];
    $price=$_POST['price'];
    $dec=$_POST['dec'];
	...
	if ($error === 0) {
		if ($img_size > 125000) {
		    ...
		    header("Location: admin-viewproduct.php?error=$em");
		}else {
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                $sql="UPDATE `product_master` SET `name`='$name',`price`='$price',`brand`='$brand',`categories`='$cat',`description`='$dec',`quantity`='$qty',`size`='$size1',`image`='$img_upload_path' ,`offer`='$offer' WHERE id=$ids";
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="offer" value="<?php echo $arr['offer'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="dec" value="<?php echo $arr['description'];?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputText" class="col-sm-2 col-form-label">Quantity</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="qty" value="<?php echo $arr['quantity'];?>">
                                        </div>
                                    </div>
                                    <!-- <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10"  id="image_box">
                                            <input class="form-control" type="file" name="file1" id="fileToUpload" value="<?php echo $arr['image'];?>">
