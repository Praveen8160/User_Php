        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            {?>
                ...
                <td><a href="delcat.php?id=<?php echo $res['id'];?>"><span class="bi bi-trash" style="font-size:1.5rem"></span></a></td>
                <td><a href="upcat.php?id=<?php echo $res['id'];?>"><i class="bi bi-pencil-square" style="font-size:1.5rem"></i></a></td>
                </tr>
                <?php
            }
            ?>
