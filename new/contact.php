...
if(isset($_POST['submit']))
{
    ...
    {
    if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['mess']) && !empty($_POST['sub']))
    {
        $name=$_POST['name'];
        $email=$_POST['email'];
        $mess=$_POST['mess'];
        $sub=$_POST['sub'];
        $sql="INSERT INTO `contact_tbl`(`username`, `email`, `subject`, `message`) VALUES ('$name','$email','$mess','$sub')";
