...
<?php
$did=$_GET['id'];
$sql="SELECT * FROM `categories_tbl` where id=$did";
...
<body style="overflow-x: hidden">
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3"><?php echo $name;?> Shop</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2"><?php echo $name;?> Products</span></h2>
        </div>
        <div class="row px-xl-5 pb-3">
            <?php
                $sql="SELECT * FROM `product_master` where categories='$name'";
                $result=mysqli_query($db,$sql);
